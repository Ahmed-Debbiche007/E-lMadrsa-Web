 ...
 */
final class Version20221104181234 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment CHANGE CommentID commentid INT AUTO_INCREMENT NOT NULL, CHANGE CommentCONTENT commentcontent VARCHAR(255) NOT NULL, CHANGE userID userid INT NOT NULL, CHANGE postID postid INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE post CHANGE postID postid INT AUTO_INCREMENT NOT NULL, CHANGE postCONTENT postcontent VARCHAR(255) NOT NULL, CHANGE userID userid INT NOT NULL, CHANGE categoryID categoryid INT NOT NULL, CHANGE postDATE postdate DATETIME NOT NULL');
        ...
        $this->addSql('ALTER TABLE question ADD examen VARCHAR(255) DEFAULT NULL, DROP idExamen, CHANGE idQuestion idquestion INT AUTO_INCREMENT NOT NULL');
        $this->addSql('CREATE INDEX IDX_B6F7494E514C8FEC ON question (examen)');
        ...
        $this->addSql('ALTER TABLE user ADD id_utilisateur INT AUTO_INCREMENT NOT NULL, ADD mot_de_passe VARCHAR(255) NOT NULL, ADD nom_utilisateur VARCHAR(255) NOT NULL, DROP nomUtilisateur, DROP tel, DROP motDePasse, DROP idUtilisateur, CHANGE email email VARCHAR(180) NOT NULL, CHANGE dateNaissance date_naissance DATE NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id_utilisateur)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment CHANGE commentid CommentID BIGINT AUTO_INCREMENT NOT NULL, CHANGE commentcontent CommentCONTENT TEXT NOT NULL, CHANGE userid userID BIGINT DEFAULT NULL, CHANGE postid postID BIGINT NOT NULL');
        ...
        $this->addSql('ALTER TABLE post CHANGE postid postID BIGINT AUTO_INCREMENT NOT NULL, CHANGE postcontent postCONTENT TEXT NOT NULL, CHANGE userid userID BIGINT DEFAULT NULL, CHANGE categoryid categoryID BIGINT DEFAULT NULL, CHANGE postdate postDATE DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
        ...
        $this->addSql('ALTER TABLE question DROP FOREIGN KEY FK_B6F7494E514C8FEC');
        $this->addSql('DROP INDEX IDX_B6F7494E514C8FEC ON question');
        $this->addSql('ALTER TABLE question ADD idExamen BIGINT DEFAULT NULL, DROP examen, CHANGE idquestion idQuestion BIGINT AUTO_INCREMENT NOT NULL');
        ...
        $this->addSql('ALTER TABLE user ADD nomUtilisateur VARCHAR(255) NOT NULL, ADD tel VARCHAR(255) NOT NULL, ADD motDePasse VARCHAR(255) NOT NULL, ADD idUtilisateur BIGINT AUTO_INCREMENT NOT NULL, DROP id_utilisateur, DROP mot_de_passe, DROP nom_utilisateur, CHANGE email email VARCHAR(255) NOT NULL, CHANGE date_naissance dateNaissance DATE NOT NULL');
