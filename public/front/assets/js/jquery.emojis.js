...
(function ($) {
    ...
    addPickerIcon: function () {
      ...
      if (this.settings.button) {
        ...
        this.$wrapper = this.$el
          .wrap("<div class='emojiPickerIconWrap dropup'></div>")
          .parent();

        this.$icon = $('<button class="emojiPickerIcon" aria-haspopup="true"><i class="fa fa-smile-o"></i></button>')
          .height(iconHeight)
          .width(iconHeight)
          .addClass("btn")
          .attr('id', 'dropdownMenuButton')
          .attr('data-toggle', 'dropdown')
          .attr('style', 'color: #435ebe ; background:#fff; ');

        this.$icon.attr('aria-expanded','false');
  ...
  function getPickerHTML() {
    ...
    nodes.push('<div class="emojiPicker dropdown-menu" aria-labelledby="emojis-button" id="emojis-card">');
...
// return('<div class="emojiPicker dropdown-menu" aria-labelledby="emojis-button" id="emojis-card"><div class ="sections">xx</div></div>');
