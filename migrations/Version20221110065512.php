 ...
 */
final class Version20221110065512 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE requests (idrequest INT AUTO_INCREMENT NOT NULL, id_tutor_id INT DEFAULT NULL, idstudent INT NOT NULL, type VARCHAR(255) NOT NULL, body VARCHAR(255) NOT NULL, date DATETIME NOT NULL, INDEX IDX_7B85D65170548864 (id_tutor_id), PRIMARY KEY(idrequest)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
